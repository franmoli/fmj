    ...
    <div class="row">
        ...
        <main id="contenido-principal" class="text-center">
            ...
            <section id="descripcion-administrar-elemento" class="text-center">
                ...
                <p>
                    (Apretando las teclas "ctrl" + "f" se puede buscar por nombre o nro)
                </p>
            </section>
                        ...
                        <section id="formulario-creacion">
                            <form id="actualizar-puntos-competidor" class="container text-center" data-usuario="<?php echo $dniUsuario; ?>" action="#">
                                ...
                                <div class="puntos-senior">
                                    <input id="puntos-senior" class="text-white text-center with-error" type="number" value=0 required>
                                    <small>
                                ...
                                <div class="puntos-cadete">
                                    <input id="puntos-cadete" class="text-white text-center with-error" type="number" value=0 required>
                                    <small>
                                        * Para sumar puntos, ingrese un número entero <br>
                                        * Para restar puntos, ingrese el símbolo '-' seguido de un número entero
                                    </small>
                                ...
                                <div class="puntos-kyuGraduado">
                                    <input id="puntos-kyuGraduado" class="text-white text-center with-error" type="number" value=0 required>
                                    <small>
                                        * Para sumar puntos, ingrese un número entero <br>
                                        * Para restar puntos, ingrese el símbolo '-' seguido de un número entero
                                    </small>
                                ...
                                <div class="puntos-kyuNovicio">
                                    <input id="puntos-kyuNovicio" class="text-white text-center with-error" type="number" value=0 required>
                                    <small>
                                        * Para sumar puntos, ingrese un número entero <br>
                                        * Para restar puntos, ingrese el símbolo '-' seguido de un número entero
                                    </small>
                                ...
                                <div class="puntos-infantilB">
                                    <input id="puntos-infantilB" class="text-white text-center with-error" type="number" value=0 required>
                                    <small>
                                        * Para sumar puntos, ingrese un número entero <br>
                                        * Para restar puntos, ingrese el símbolo '-' seguido de un número entero
                                    </small>
                                ...
                                <!-- Puntos Infantil B -->
                                <h3 class="text-left">PUNTOS EN LA CATEGORÍA JUNIOR</h3>
                                <div class="puntos-junior">
                                    <input id="puntos-junior" class="text-white text-center with-error" type="number" value=0 required>
                                    <small>
                                        * Para sumar puntos, ingrese un número entero <br>
                                        * Para restar puntos, ingrese el símbolo '-' seguido de un número entero
                                    </small>
