...
$rankingSeleccionado = '';
$categoriaSeleccionada = 'senior';
if (isset($_GET['categoria'])) $categoriaSeleccionada = $_GET['categoria'];
if (isset($_GET['ranking'])) $rankingSeleccionado = $_GET['ranking'];

switch ($categoriaSeleccionada) {
    case 'senior':
        $categoriaQuerie = "SENIOR";
        break;
    case 'cadete':
        $categoriaQuerie = "CADETE";
        break;
    case 'junior':
        $categoriaQuerie = "JUNIOR";
        break;
    case 'kyuGraduado':
        $categoriaQuerie = "KYU GRADUADO";
        break;
    case 'kyuNovicio':
        $categoriaQuerie = "KYU NOVICIO";
        break;
    case 'infantilB':
        $categoriaQuerie = "INFANTIL B";
        break;
...
if (!$rankingSeleccionado) {
    //COMPETIDORES
    $cargarCompetidor = " SELECT * FROM competidores WHERE categoria = '$categoriaQuerie'";
    ...
    //COMPETIDORES
    $cargarCompetidor = " SELECT dni, club FROM competidores WHERE categoria = '$categoriaQuerie'";
    $resultadoBD = $con->query($cargarCompetidor);
    ...
    //COMPETIDORES
    $cargarCompetidor = " SELECT dni, federacion FROM competidores WHERE categoria = '$categoriaQuerie'";
    $resultadoBD = $con->query($cargarCompetidor);
        ...
        <section class="ranking-section ranking-competidores">
            ...
            <div class="categorias container text-center">
                ...
                <div class="row text-center">
                    ...
                    <a href="ranking.php?categoria=junior" class="col-md-2 botonCategoria <?php if ($categoriaSeleccionada == "junior") echo "active"; ?>">Junior</a>
                        ...
                        <tbody>
                            ...
                            foreach ($competidores as $competidor) {
                                ...
                                while ($puntosObtenidos = $resultadoBD->fetch_assoc()) {
                                    ...
                                    else if ($categoriaSeleccionada == "junior") $puntosCategoria += $puntosObtenidos['puntos_junior'];
                                            ...
                                            <div class="modal-content" style="padding:2rem;">
                                                <div class="informacion_puntos">
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                            <li><?php echo $torneoSeleccionado ?>: <?php echo $puntos['puntos_junior']; ?> pts.</li>
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <li><?php echo $torneoSeleccionado ?>: <?php echo $puntos['puntos_senior'] + $puntos['puntos_cadete'] + $puntos['puntos_kyu_graduado'] + $puntos['puntos_kyu_novicio'] + $puntos['puntos_infantil_b'] + $puntos['puntos_junior'] ?> pts.</li>
                                                    <?php
                                                        }
                                                    }
                                                    ?>
        ...
        <section class="ranking-section ranking-clubes">
            ...
            <div class="categorias container text-center">
                ...
                <div class="row text-center">
                    ...
                    <a href="ranking.php?ranking=club&categoria=junior" class="col-md-2 botonCategoria <?php if ($categoriaSeleccionada == "junior") echo "active"; ?>">Junior</a>
                                ...
                                foreach ($competidores as $posicion => $competidor) {
                                    if ($competidor['club'] == $club['club']) {
                                        ...
                                        while ($puntosObtenidos = $resultadoBD->fetch_assoc()) {
                                            ...
                                            else if ($categoriaSeleccionada == "juior") $puntosCategoria += $puntosObtenidos['puntos_junior'];
                                            else $puntosCategoria += ($puntosObtenidos['puntos_senior'] + $puntosObtenidos['puntos_cadete'] + $puntosObtenidos['puntos_kyu_graduado'] + $puntosObtenidos['puntos_kyu_novicio'] + $puntosObtenidos['puntos_infantil_b'] + $puntosObtenidos['puntos_junior']);
                                        }
        ...
        <section class="ranking-section ranking-federaciones">
            ...
            <div class="categorias container text-center">
                ...
                <div class="row text-center">
                    ...
                    <a href="ranking.php?ranking=federacion&categoria=junior" class="col-md-2 botonCategoria <?php if ($categoriaSeleccionada == "junior") echo "active"; ?>">Junior</a>
