    ...
    <main id="contenido-principal" class="text-center">
        ...
        <section id="formulario-creacion">
            <form id="crear-torneo" class="container text-center" action="#">
                ...
                <!-- Nombre -->
                <div class="nombre">
                    <input id="nombre-torneo" class="text-white text-center with-error" type="text"
                           placeholder="NOMBRE">
                    <small>
                ...
                <div class="categoria">
                    ...
                    <fieldset id="categorias-torneo" class="checkbox-button" value="CATEGORÍAS PARTICIPANTES">
                        <div class="row">
                            ...
                            <div class="col-md-4 checkbox-button">
                                <input id="categoria-kyuGraduado" type="checkbox" name="categorias-torneo"
                                       value="KYU GRADUADO">
                        ...
                        <div class="row">
                            <div class="col-md-6 checkbox-button">
                                <input id="categoria-kyuNovicio" type="checkbox" name="categorias-torneo"
                                       value="KYU NOVICIO">
                            ...
                            <div class="col-md-6 checkbox-button">
                                <input id="categoria-infantilB" type="checkbox" name="categorias-torneo"
                                       value="INFANTIL B">
                ...
                <!-- Reglas -->
                <div class="reglas">
                    <div class="reglas-torneo"><input id="reglas-torneo" class="text text-center" type="file"
                                                      placeholder="REGLAS DEL TORNEO"></div>
                ...
                <div class="foto">
                    <div class="foto-torneo"><input id="foto-torneo" class="fotarda text text-center" type="file"
                                                    value="FOTO"></div>
