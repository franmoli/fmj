...
if (!$competidorObtenido || (strtoupper($competidorObtenido['club']) != strtoupper($_SESSION['club']) && $_SESSION['admin_level'] > 1)) echo '<meta http-equiv="refresh" content="0; url=administrar-competidores.php">';
?>
                    ...
                    <div class="categoria">
                        ...
                        <fieldset id="categoria-competidor" class="radio-button" value="CATEGORÍA">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 radio-button">
                                    <input id="categoria-junior" type="radio" value="JUNIOR" name="categoria-competidor" <?php if ($competidorObtenido['categoria'] == "JUNIOR") echo "checked"; ?>>
