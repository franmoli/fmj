    ...
    <section class="federaciones">
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="federacion col-md-4 col-lg-4" style="margin: 0 auto;">
    ...
    <section class="parches">
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="federacion col-md-12 col-lg-12">
                    <a href="parches.php"><img src="img/Parches/met-cuerpo.jpeg" alt="MET" style="max-width: 300px;"></a>
